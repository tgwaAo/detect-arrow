...
class Calibrator:
    ...
    def img_corners_into_list(self, path: str = calibration_images_basepath, save: bool = True) -> bool:
    ...
    def prepare_undistortion(self, alpha: int = 1, path: str = calibration_images_basepath) -> None:
