...
RAW_POS_IMGS_PATH = '../raw-positive-images/'
RAW_NEG_IMGS_PATH = '../raw-negative-images/'
UNUSED_NEG_PATH = '../unused-negatives/'
ORIGINAL_POS_PATH = 'original-positives/'
ORIGINAL_POS_SUB_PATH = str(PurePath(ORIGINAL_POS_PATH, PurePath(ORIGINAL_POS_PATH).name))
ORIGINAL_NEG_PATH = 'original-negatives/'
ORIGINAL_NEG_SUB_PATH = str(PurePath(ORIGINAL_NEG_PATH, PurePath(ORIGINAL_NEG_PATH).name))
