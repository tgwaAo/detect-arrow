...
if __name__ == '__main__':
    ...
    pos_roughly_created_size = get_nbr_of_imgs_for_aug(
        preparator.org_pos_sub_path,
        'positive'
    )
    neg_roughly_created_size = get_nbr_of_imgs_for_aug(
        preparator.org_neg_sub_path,
        'negative'
    )
    ...
    saved_bname = pl.PurePath(
        f'{default_model_bname.stem}_{preparator.path_idx}{default_model_bname.suffix}'
    )
