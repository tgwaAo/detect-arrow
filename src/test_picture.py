...
try:
    ...
    if (best_prob > 0):
        ...
        print("The horizontal distance from center of arrow to center of "
              + "image is ", dx_px, " pixel and the vertical distance is ",
              dy_px, " pixel.")
        ...
        cv2.line(im, (best_x_c, best_y_c), (best_x_c, best_y_c), (255, 255, 0),
                 20)
